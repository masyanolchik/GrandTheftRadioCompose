package com.example.grandtheftradio.ui.favoritesscreen
...
@FlowPreview
@Composable
fun FavoritesScreen(viewModel: RadioChooserViewModel) {
    var stations by remember { mutableStateOf(viewModel.searchQuery(true, "")) }
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Surface(
            ...
            Column(modifier = Modifier.background(ColorPrimary)){
                TextField(
                    ...
                    onValueChange = {
                        text = it
                        stations = viewModel.searchQuery(true,it)
                    },
                    label = {
                        Text("Station, game")
                    },
                    ...
                    modifier = Modifier
                        ...
                        .clickable(onClick = {
                            if (selectedTags.contains(it)) {
                                ...
                                stations = viewModel.searchQuery(true, text)
                            } else {
